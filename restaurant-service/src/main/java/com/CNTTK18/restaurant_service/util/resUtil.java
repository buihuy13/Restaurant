...
public class resUtil {
    public static resResponse mapResToResResponse(restaurants res) {
        return resResponse.builder()
                        ...
                        .products(productUtil.maProductWithoutResResponseSet(res.getProducts()))
                        .build();
    }
    ...
    public static productRestaurant mapProductRestaurant(restaurants res) {
        return productRestaurant.builder()
                        .id(res.getId())
                        .address(res.getAddress())
                        .resName(res.getResName())
                        .longitude(res.getLongitude())
