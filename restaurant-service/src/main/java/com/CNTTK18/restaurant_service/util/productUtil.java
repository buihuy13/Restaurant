...
public class productUtil {
    public static productResponse mapProductToProductResponse(
            products product, resResponse resResponse) {
    ...
    public static productResponseWithoutRes mapProductToProductResponseWithoutResParam(
            products product) {
        return productResponseWithoutRes
                .builder()
                .available(product.isAvailable())
                .id(product.getId())
                .categoryId(product.getCategory().getId())
