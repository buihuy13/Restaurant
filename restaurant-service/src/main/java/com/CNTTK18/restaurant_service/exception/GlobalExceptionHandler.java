...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleResourceNotFoundException(
        ...
        ErrorResponse errorResponse =
                new ErrorResponse("Error while calling another service", ex.getMessage());
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<ErrorResponse> handleDistanceDurationException(
            DistanceDurationException ex) {
        ErrorResponse errorResponse =
                new ErrorResponse("Invalid distance or duration", ex.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
    }
