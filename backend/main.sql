...
(UUID(), 'RES001', 1250.50, 1250.50, 0),
(UUID(), 'RES002', 450.25, 450.25, 0),
(UUID(), 'RES003', 120.00, 120.00, 0),
(UUID(), 'RES004', 875.00, 875.00, 0),
(UUID(), 'RES005', 2100.75, 2100.75, 0),
(UUID(), 'RES006', 340.50, 340.50, 0),
(UUID(), 'RES007', 615.00, 615.00, 0),
(UUID(), 'RES008', 980.20, 980.20, 0),
(UUID(), 'RES009', 1540.00, 1540.00, 0),
(UUID(), 'RES010', 210.40, 210.40, 0),
(UUID(), 'RES011', 725.30, 725.30, 0),
(UUID(), 'RES012', 110.00, 110.00, 0),
(UUID(), 'RES013', 3200.00, 3200.00, 0),
(UUID(), 'RES014', 540.60, 540.60, 0),
(UUID(), 'RES015', 890.00, 890.00, 0),
