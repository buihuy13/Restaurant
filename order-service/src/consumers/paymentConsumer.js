...
const startPaymentConsumer = async () => {
    try {
        ...
        await rabbitmqConnection.consumeMessage(process.env.RABBITMQ_QUEUE_PAYMENT_COMPLETED, async (message) => {
        ...
        await rabbitmqConnection.consumeMessage(process.env.RABBITMQ_QUEUE_PAYMENT_FAILED, async (message) => {
