...
const eurekaClient = new Eureka({
  instance: {
    ...
    statusPageUrl: `http://${process.env.EUREKA_INSTANCE_HOSTNAME || 'order-service'}:${process.env.PORT || 8082}/health`,
    healthCheckUrl: `http://${process.env.EUREKA_INSTANCE_HOSTNAME || 'order-service'}:${process.env.PORT || 8082}/health`,
