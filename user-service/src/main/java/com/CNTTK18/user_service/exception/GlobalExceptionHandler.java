...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBadCredentialsException(BadCredentialsException ex) {
        ErrorResponse errorResponse =
                new ErrorResponse("BAD_CREDENTIALS", "Tên đăng nhập hoặc mật khẩu không đúng");
    ...
    public ResponseEntity<ErrorResponse> handleOAuth2AuthenticationException(
        ...
        ErrorResponse errorResponse =
                new ErrorResponse("OAUTH2_AUTHENTICATION_ERROR", ex.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
    }
    ...
    public ResponseEntity<ErrorResponse> handleInactivateException(InactivateException ex) {
        ErrorResponse errorResponse = new ErrorResponse("INACTIVATED_ACCOUNT", ex.getMessage());
